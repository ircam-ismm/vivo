...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 36.0, 276.0, 71.0, 22.0 ],
					"text" : "optical_flow"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 331.0, 346.0, 42.0, 20.0 ],
					"text" : "rear R"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 289.0, 346.0, 40.0, 20.0 ],
					"text" : "rear L"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 242.0, 346.0, 45.0, 20.0 ],
					"text" : "front R"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 191.0, 346.0, 43.0, 20.0 ],
					"text" : "front L"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 147.0, 346.0, 42.0, 20.0 ],
					"text" : "center"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 378.5, 426.0, 40.0, 20.0 ],
					"text" : "Spat?"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 147.0, 374.0, 229.0, 124.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"size" : 5
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 36.0, 854.0, 60.0, 32.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 36.0, 901.0, 355.0, 47.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 313.0, 702.0, 90.0, 20.0 ],
					"style" : "default",
					"text" : "Down: Yellow"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 236.0, 702.0, 76.0, 20.0 ],
					"style" : "default",
					"text" : "Up: Blue"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 141.0, 701.0, 69.0, 20.0 ],
					"style" : "default",
					"text" : "Right: Red"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 701.0, 76.0, 20.0 ],
					"style" : "default",
					"text" : "Left: Green"
				}
...
,
					"patching_rect" : [ 36.0, 652.0, 78.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 220.0, 725.0, 160.0, 120.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 36.0, 725.0, 160.0, 120.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 260.0, 680.0, 120.0, 20.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 62.0, 680.0, 134.0, 20.0 ],
					"style" : "default",
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 104.5, 681.0, 229.5, 681.0 ],
					"source" : [ "obj-43", 1 ]
				}
